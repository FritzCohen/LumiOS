...
const Window: React.FC<WindowProps> = ({ app }) => {
	...
	const style: React.CSSProperties = {
		...
		borderRadius: app.maximized ? "0px" : "0.375rem",
	...
	return (
		<>
			...
			<Rnd
				...
				className="glass z-30 border border-border-default"
			>
				<div
				...
				>
					<div
						className="flex flex-row items-center justify-between rounded-t-sm drag-handle cursor-move topbar drag-handle shadow-lg"
					...
					>
						...
						<div className="h-full flex">
							{!app.disableMinimize && (
								<button
									className="transition-all duration-100 active:scale-95 w-12 h-8 hover:bg-surfaceAlt"
									onClick={handleMinimize}
								>
									<FontAwesomeIcon
							...
							{!app.disableClose && (
								<button
									className="transition-all duration-100 active:scale-95 w-12 h-8 hover:bg-danger"
									onClick={handleClose}
								>
