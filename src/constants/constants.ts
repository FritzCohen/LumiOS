...
/**
 * Current name of the OS
 * 
 * Still needs ~some~ implementation
*/
export const OS_NAME = "LumiOS";

/**
 * Github link
 * 
 * Change to custom github if you want...
*/
export const GITHUB_LINK = "https://github.com/FritzCohen/LumiOS";
...
export function getIconForFile(arg: File | Directory | Executable | string): string {
	if (typeof arg === "string") {
	...
	} else if ("config" in arg) {		
		return arg.config.icon as string;
	} else {
		...
		switch (fileType) {
			...
			case "sys":
				return config;
			case "shortcut":
				return arg.content?.icon ?? shortcutIcon;
			case "css":
			case "html":
			case "theme":
			case "img":
...
export const defaultUIStyle: UIStyleTheme = {
	spacing: "",
	rounding: "0.5rem",
	padding: "2px",
	iconSize: "",
	glassAlpha: 0.75,
	globalGlassAlpha: 0.75,
	taskbar: {
		rounding: "0.5rem",
		onHover: true,
		mode: "floating",
...
import { BrowserConfig, PanicConfig, UIStyleTheme } from "../context/user/userTypes";
...
export const cloaks = [
	...
	},
	{
		...
		favicon:
			"https://assets.quizlet.com/a/j/dist/app/i/logo/2021/q-twilight.e27821d9baad165.png",
	},
];
