...
// -------------------------------------------------------------
// Items and executables
// -------------------------------------------------------------
export interface Privileges {
  read: boolean;       // view contents
  write: boolean;      // modify contents
  execute: boolean;   // run/open
  create: boolean;    // create child items
  delete: boolean;    // delete self or children
  list: boolean;      // see in a directory listing
  configure: boolean; // modify config or permissions
}
