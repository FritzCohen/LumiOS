...
import { DEFAULT_WINDOW_HEIGHT, DEFAULT_WINDOW_WIDTH } from "../../constants/constants";
  ...
  switch (action.type) {
    case "OPEN_APP": {
      ...
      const newApp: OpenedApp = {
        ...
        x: window.innerWidth / 2 - DEFAULT_WINDOW_WIDTH/2,
        y: window.innerHeight / 2 - DEFAULT_WINDOW_HEIGHT/2,
